...
CREATE TABLE `loan_apply_t` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='借款申请后台表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approve_log_t` (
  ...
  `last_updated_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='审批日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `urgent_contactor_t` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='紧急联系人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dict_t` (
  ...
  PRIMARY KEY (`dict_id`)
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='数据字典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rule_t` VALUES (1,' 名族校验',1,'','test2','2015-11-07 04:39:33','test','2015-11-07 04:39:33','名族校验拦截');
...
CREATE TABLE `dimension_t` (
  ...
  PRIMARY KEY (`dis_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='维度配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dimension_t` VALUES (2,1,'user_info','thnic_v','=','维吾尔族','and','test','2015-11-07 04:39:33','test','2015-11-07 04:39:33',NULL);
...
CREATE TABLE `credit_score_t` (
  ...
  `dimension_name` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '维度名',
  `proportion` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权重',
  `model_name` int(11) DEFAULT NULL COMMENT '模型名称',
...
INSERT INTO `credit_score_item_t` VALUES (11,5,1,'>','10000',100,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(12,5,2,'>','8000',90,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(13,5,3,'>','6000',80,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(14,5,4,'>','4000',70,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(15,5,5,'>','2000',60,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(16,5,6,'<','2000',0,'test','2015-11-16 15:41:22','test','2015-11-16 15:41:22',NULL),(17,6,10,'=','10',10,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(18,6,9,'=','9',20,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(19,6,8,'=','8',30,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(20,6,7,'=','7',40,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(21,6,6,'=','6',50,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(22,6,5,'=','5',60,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(23,6,4,'=','4',70,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(24,6,3,'=','3',80,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(25,6,2,'=','2',90,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(26,6,1,'=','1',100,'test','2015-11-16 15:43:54','test','2015-11-16 15:43:54',NULL),(38,7,1,'=','1',100,'test','2015-11-16 15:50:31','test','2015-11-16 15:50:31',NULL),(39,7,2,'=','2',90,'test','2015-11-16 15:50:31','test','2015-11-16 15:50:31',NULL),(40,7,3,'=','3',80,'test','2015-11-16 15:50:31','test','2015-11-16 15:50:31',NULL),(41,7,4,'=','4',70,'test','2015-11-16 15:50:31','test','2015-11-16 15:50:31',NULL),(42,7,5,'=','5',60,'test','2015-11-16 15:50:31','test','2015-11-16 15:50:31',NULL),(43,8,7,'>','0.25',40,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(44,8,6,'>','0.5',50,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(45,8,5,'>','1',60,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(46,8,4,'>','2',70,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(47,8,3,'>','3',80,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(48,8,2,'>','4',90,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(49,8,1,'>','5',100,'test','2015-11-16 15:53:04','test','2015-11-16 15:53:04',NULL),(50,9,9,'<','350',20,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(51,9,8,'>','350',30,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(52,9,7,'>','400',40,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(53,9,6,'>','450',50,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(54,9,5,'>','500',60,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(55,9,4,'>','550',70,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(56,9,3,'>','600',80,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(57,9,2,'>','650',90,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(58,9,1,'>','700',100,'test','2015-11-16 15:56:07','test','2015-11-16 15:56:07',NULL),(64,10,1,'=','1',100,'test','2015-11-16 15:58:00','test','2015-11-16 15:58:00',NULL),(65,10,2,'=','2',90,'test','2015-11-16 15:58:00','test','2015-11-16 15:58:00',NULL),(66,10,3,'=','3',70,'test','2015-11-16 15:58:00','test','2015-11-16 15:58:00',NULL),(67,10,4,'=','4',80,'test','2015-11-16 15:58:00','test','2015-11-16 15:58:00',NULL),(68,10,5,'=','5',60,'test','2015-11-16 15:58:00','test','2015-11-16 15:58:00',NULL),(69,11,2,'=','0',90,'test','2015-11-16 15:58:50','test','2015-11-16 15:58:50',NULL),(70,11,1,'=','1',100,'test','2015-11-16 15:58:50','test','2015-11-16 15:58:50',NULL),(71,12,2,'=','0',90,'test','2015-11-16 15:59:28','test','2015-11-16 15:59:28',NULL),(72,12,1,'=','1',100,'test','2015-11-16 15:59:28','test','2015-11-16 15:59:28',NULL);
