...
$(function(){
    ...
    $("#contractGrid").jqGrid({
			...
			height:205,
			autowidth:true,
			colNames:['合同编号','合同编号','借款金额','借款人姓名','投资人姓名','合同生产时间'],
			colModel :[
				{
					name:'contract_id', index:'loan_id',align:'center',"sortable":false, hidden:true
				},
				{	name:'contract_id_render', index:'contract_id', align:'center', "sortable":false,
