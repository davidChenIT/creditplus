 ...
 <!-- 中间区域 -->
  <section id="credit_Body" class="credit-layout layout-equalheight ">
       <section class="row">
            ...
            <script src="<%=request.getContextPath()%>/js/credit/resourceList.js" type="text/javascript"></script>
            <!--  主区域start -->
			<div id="credit_MainPanel" class="equalheight-item render content-credit-mainPanel creditRendered credit-fullscreen" widget="fullScreen">
				...
				<div id="credit_Main" class="credit-page creditPageContext" creditpagecontextid="main">
				    <div>
						<!-- 整个tab控件区域 -->
						<div hw_id="_hw_8117" name="resourceTab" widget="tab" class="creditRendered credit-tabs" id="Tab_47892031">
							<!-- 标题区域 -->
							<div class="tabs-head">
									...
									<ul>
										<li tabid="resourceList" class="tabs-selected"><span>资源列表</span></li>
									</ul>
							</div>
							<!-- 标题区域end -->
							<!-- 内容区域start -->
							<div class="tabs-body">
								<!-- 页签1 -->
								<div tabid="resourceList" class="tabs-body-item creditPageContext credit-validator" creditpagecontextid="page_85823101">
									<div>
									    <!-- 条件区域开始 -->
										<div class="row">
											...
											<div class="search-y-btn creditRendered" style="display: inline-block;">
												<button class="credit-btn" id="searchResourceListBtn" type="button">查询</button>
											</div>	
										</div>	
									
									    <!-- grid按钮区域 -->
									    <div style="display: inline-block;">
											<button class="grid-toobar-btn add-btn" name="addResourceBtn" type="button">新增</button>
											<button class="grid-toobar-btn del-btn" name="delResourceBtn" type="button">删除</button>
										</div>
									
										<!-- grid区域开始 -->
										
										<div class="row">
											<table id="resourceListGrid"></table> 

											<div id="resourceListPager"></div>
										</div>
										<!-- grid区域结束 -->
									</div>
								</div>
