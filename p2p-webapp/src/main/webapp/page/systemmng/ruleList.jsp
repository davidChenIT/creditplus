 ...
 <!-- 中间区域 -->
  <section id="credit_Body" class="credit-layout layout-equalheight ">
       <section class="row">
            ...
            <script src="<%=request.getContextPath()%>/js/credit/ruleList.v.1.0.js" type="text/javascript"></script>
            <!--  主区域start -->
			<div id="credit_MainPanel" class="equalheight-item render content-credit-mainPanel creditRendered credit-fullscreen" widget="fullScreen">
				...
				<div id="credit_Main" class="credit-page creditPageContext" creditpagecontextid="main">
				    <div>
						<!-- 整个tab控件区域 -->
						<div hw_id="_hw_8117" name="ruleTab" widget="tab" class="creditRendered credit-tabs">
							<!-- 标题区域 -->
							<div class="tabs-head">
									...
									<ul>
										<li tabid="ruleList" class="tabs-selected"><span>规则列表</span></li>
									</ul>
							</div>
							<!-- 标题区域end -->
							<!-- 内容区域start -->
							<div class="tabs-body">
								<!-- 页签1 -->
								<div tabid="ruleList" class="tabs-body-item creditPageContext credit-validator">
									<div>
									    <!-- 条件区域开始 -->
										<div class="row">
											...
											<div class="credit-toolbar" style="display: inline-block;">
												<div >
													<button class="grid-toobar-btn search-btn guide-btn" id="searchRuleListBtn" type="button">查询</button>
												</div>
											</div>
										</div>	
									    ...
									    <div style="display: inline-block;">
											<button class="grid-toobar-btn add-btn" name="addRuleBtn" type="button">新增</button>
											<button class="grid-toobar-btn del-btn" name="delRuleBtn" type="button">删除</button>
										</div>
									
										<!-- grid区域开始 -->
										
										<div class="row">
											<table id="ruleListGrid"></table> 
