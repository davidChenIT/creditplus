 ...
 <!-- 中间区域 -->
  <section id="credit_Body" class="credit-layout layout-equalheight ">
       <section class="row">
            ...
            <script src="<%=request.getContextPath()%>/js/credit/catalogList.js" type="text/javascript"></script>
            <!--  主区域start -->
									...
									<div>
										...
										<div class="row">
											...
											<div class="credit-toolbar" style="display: inline-block;">
												<div >
													<button class="grid-toobar-btn search-btn" id="searchCatalogListBtn" type="button">查询</button>
												</div>
											</div>
										</div>	
